...
{	public static void main(String[] args)
	{	ContoCorrente c1 = new ContoCorrente("ITQ0122345","Mario Rossi");
		...
		c3.aggiungiMovimento(new Movimento("deposito",1100));
		...
		Terminale.stampa("*****************\nI seguenti conti correnti non contengono stipendi:\n");
		ArrayList<ContoCorrente> contiSenzaStipendi = banca.cercaContiSenzaMovimentiTipo("stipendio");
		for(ContoCorrente c : contiSenzaStipendi)
			Terminale.stampa(c);
	}	
}
